...
public class CustomerController {
    ...
    public List<Product> fetchAllProducts(@PathVariable String category) {
        return this.customerService.fetchAllProductsByCategory(category);
    }
    ...
    public List<Product> recommendations(HttpServletRequest request) {
        return this.customerService.recommend(request);
    }

    @GetMapping("/product/collaborative-filtering")
    public List<Product> collaborativeFiltering(HttpServletRequest request) {
        return this.customerService.collaborativeFiltering(request);
    }
}
